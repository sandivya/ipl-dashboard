...
public class BatchConfiguration {
    ...
    private final String[] MATCH_FIELDS = new String[] { "id", "city", "date", "player_of_match", "venue",
    ...
    public FlatFileItemReader<MatchInput> reader() {
        return new FlatFileItemReaderBuilder<MatchInput>().name("matchItemReader")
                .resource(new ClassPathResource("match-data.csv")).delimited().names(MATCH_FIELDS)
